...
def train(train_loader, model, criterion, optimizer, epoch, writer, args):
    ...
    for i, (images, target) in enumerate(train_loader):
        ...
        writer.add_scalar("loss", loss.item(), 195*epoch+i)
...
def sanity_check(state_dict, pretrained_weights):
    ...
    for k in list(state_dict.keys()):
        ...
        if "net.9.weight" in k or "net.9.bias" in k:
            continue
...
def main():
    ...
    # data prepare
    train_data = CIFAR10(root='data', train=True, transform=train_transform, download=False)
    ...
    model = ModelBase(feature_dim=10, arch=args.arch, bn_splits=8)
    print(model)
    ...
    writer = {
        "loss": SummaryWriter("summary_pic/cls/loss"),
        "acc": SummaryWriter("summary_pic/cls/acc")
    }
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # train for one epoch
        train(train_loader, model, criterion, optimizer, epoch, writer['loss'], args)

        # evaluate on validation set
        acc1 = validate(test_loader, model, criterion, args)
        writer['acc'].add_scalar("acc1", acc1, epoch)
